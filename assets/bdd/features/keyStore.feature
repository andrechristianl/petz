Feature: Codes Resources  
  ...
  Scenario: Test POST http://172.10.0.12:8080/ppid/encrypt | Status 200 | Encrypt
  ...
  Scenario: Test POST http://172.10.0.12:8080/ppid/encrypt | Status 200 | Encrypt branco
    Given path 'ppid/encrypt'
    And request [{  plaintext: '' }]
    When method POST    
    Then status 200

  Scenario: Test POST http://172.10.0.12:8080/ppid/encrypt | Status 200 | Encrypt null
    Given path 'ppid/encrypt'
  ...
  Scenario: Test POST http://172.10.0.12:8080/ppid/decrypt | Status 200 | Decrypt
  ...
  Scenario: Test POST http://172.10.0.12:8080/ppid/decrypt | Status 400 | Decrypt Branco
    Given path 'ppid/decrypt'
  ...
  Scenario: Test POST http://172.10.0.12:8080/ppid/decrypt | Status 400 | Decrypt Null
    Given path 'ppid/decrypt'
